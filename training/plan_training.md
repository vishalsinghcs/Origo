...
- **Details**: Identical pipeline structure to Layer 1, but loads `Qwen/Qwen2.5-8B-Instruct` and targets the `datasets/formatted/layer2/` data. Saves checkpoints to `training/layer2_specialist/checkpoints/`.
